...
def create_model(aux, num_classes, pretrain=True):
    ...
    if pretrain:
        weights_dict = torch.load("../weights/deeplabv3_mobilenet_v3_large.pth", map_location='cpu')
...
def parse_args():
    ...
    parser.add_argument("--data-path", default="../data/BDD10k/", help="Subset of BDD100K")
