...
from dataset.dataset_bddoia import BddoiaDataset
...
def main(args):
    ...
    num_classes = args.num_classes  # tuple (4, 21)

    # to save information during training and verification
    results_file = "results{}.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))

    train_dataset = BddoiaDataset(args.data_path, train_set=True)

    val_dataset = BddoiaDataset(args.data_path, train_set=False)
