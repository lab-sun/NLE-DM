...
class BddoiaDataset(Dataset):
    def __init__(self, Root, cropSize=(1280, 720), train_set=False):
        ...
        if train_set:
            ...
            with open(os.path.join(self.gtRoot, "test_25k_images_actions.json")) as json_file:
                action = json.load(json_file)
            with open(os.path.join(self.gtRoot, "test_25k_images_reasons.json")) as json_file:
