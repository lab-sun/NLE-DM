"""
To quantitatively evaluate the prediction performance of network that jointly predict action and corresponding reason.
...
def create_model(aux, num_classes: tuple, pretrain=True):
    ...
    if pretrain:
        weights_dict = torch.load("../weights/act_rea/act_rea_resnet50.pth", map_location='cpu')
