"""
To quantitatively evaluate the prediction performance of network that jointly predict action and environment description.
...
import torch
import time
from src import act_des_resnet50, act_des_resnet101
